/******/ (function(modules) {
  ...
  /******/ /******/ return __webpack_require__(
    (__webpack_require__.s = "./src/javascript/component.js")
  );
  /******/
})(
  /************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        vue__WEBPACK_IMPORTED_MODULE_0__["default"].component(
          "parent-component",
          {
            ...
            template:
              '<p><comp-child id="parent" :val="word" class="item parent"></comp-child><comp-child val="word" class="item"></comp-child></p>'
          }
        );

        vue__WEBPACK_IMPORTED_MODULE_0__["default"].component("comp-child", {
          props: {
            val: {
              type: String,
              default: "A"
        ...
        vue__WEBPACK_IMPORTED_MODULE_0__["default"].component("nest-parent", {
          data: function data() {
            return {
              list: [
          ...
          methods: {
            handleAttack: function handleAttack(id) {
              // findは参照渡しをする
        ...
        vue__WEBPACK_IMPORTED_MODULE_0__["default"].component("nest-child", {
          props: {
            name: {
              type: String,
              default: "スライム"
        ...
        vue__WEBPACK_IMPORTED_MODULE_0__["default"].component(
          "parent-emit-component",
          {
            ...
            template:
              '<child-emit-component @child-event="parentMethod" @click.native="doTestAction" ref="child"></child-emit-component>'
          }
        );
        ...
        vue__WEBPACK_IMPORTED_MODULE_0__["default"].component(
          "child-emit-component",
          {
            ...
            template:
              '<button @click="handlerClick">\u30A4\u30D9\u30F3\u30C8\u306E\u9001\u4FE1</button>'
          }
        );
        ...
        vue__WEBPACK_IMPORTED_MODULE_0__["default"].component("parent-method", {
          ...
          template:
            '<child-method @child-method="parentMethod($event, parentData)"></child-method>'
        });
        ...
        vue__WEBPACK_IMPORTED_MODULE_0__["default"].component(
          "scope-slot-child",
          {
            ...
            template:
              '<div class="scope-slot-child"><slot v-for="item in list" :item="item"></slot></div>'
          }
        );
        ...
        vue__WEBPACK_IMPORTED_MODULE_0__["default"].component(
          "parent-calender",
          {
            ...
            template:
              '<child-calender v-model="date"><p slot="ymd">{{ date }}</p></child-calender>'
          }
        );
        ...
        vue__WEBPACK_IMPORTED_MODULE_0__["default"].component(
          "child-calender",
          {
            ...
            template:
              '<p @click="sendDate">\u30AB\u30EC\u30F3\u30C0\u30FC<slot name="ymd"></slot></p>'
          }
        );
        ...
        vue__WEBPACK_IMPORTED_MODULE_0__["default"].component("sync-child", {
          ...
          template:
            '<div class="sync-child"><p>\u540D\u524D: {{ name }} HP: {{ hp }}</p><p>\u540D\u524D <input v-model="localName"><p>HP <input v-model.number="localHp"></p></div>'
        });
        ...
        vue__WEBPACK_IMPORTED_MODULE_0__["default"].component(
          "my-component-parent",
          {
            ...
            template:
              '<div><button @click="current^=1">toggle</button><keep-alive><div :is="component"></div></keep-alive></div>'
          }
        );
