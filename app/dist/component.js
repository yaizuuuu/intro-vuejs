...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/javascript/component.js");
/******/ })
/************************************************************************/
/******/ ({
...
vue__WEBPACK_IMPORTED_MODULE_0__["default"].component("parent-component", {
  data: function data() {
    return {
      word: "これはメッセージ"
    };
...
vue__WEBPACK_IMPORTED_MODULE_0__["default"].component("nest-parent", {
  data: function data() {
    return {
      list: [{ id: 1, name: "スライム", hp: 100 }, { id: 2, name: "ゴブリン", hp: 300 }, { id: 3, name: "ドラゴン", hp: 500 }]
    };
  },
  ...
  template: "<ul>" + "<nest-child v-for=\"item in list\" :key=\"item.id\" :name=\"item.name\" :hp=\"item.hp\" @attack=\"handleAttack\">" + "</nest-child>" + "</ul>"
});
...
vue__WEBPACK_IMPORTED_MODULE_0__["default"].component("nest-child", {
  ...
  template: "<li>{{ name }} HP.{{ hp }}" + "<button @click=\"doAttack\">\u653B\u6483\u3059\u308B</button></li>"
});

vue__WEBPACK_IMPORTED_MODULE_0__["default"].component("parent-emit-component", {
  methods: {
...
vue__WEBPACK_IMPORTED_MODULE_0__["default"].component("my-component-a", {
  mixins: [mixin],
  data: function data() {
    return {
      components: "A"
...
vue__WEBPACK_IMPORTED_MODULE_0__["default"].component("my-component-b", {
  mixins: [mixin],
  data: function data() {
    return {
      components: "B"
...
vue__WEBPACK_IMPORTED_MODULE_0__["default"].component("my-component-parent", {
  data: function data() {
    return {
...
vue__WEBPACK_IMPORTED_MODULE_0__["default"].component("functional-component", {
  functional: true,
  props: {
    messenger: {
      type: String,
